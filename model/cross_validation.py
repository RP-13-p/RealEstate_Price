"""K-Fold cross-validation on a 20% data sample, to estimate metric variance
without retraining on the full dataset."""
import pandas as pd
import numpy as np
...
# Sample 20% to speed up iteration
...
# 3 folds instead of 5, for speed
print("-" * 60)
